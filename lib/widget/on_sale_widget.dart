...
class OnSaleWidget extends StatefulWidget {
  ...
  const OnSaleWidget({super.key, required this.nama, required this.harga, required this.images,  required this.alamat, required this.keys});

  @override
  State<OnSaleWidget> createState() => _OnSaleWidgetState(nama, harga, images, alamat, keys);
}
...
class _OnSaleWidgetState extends State<OnSaleWidget> {
  ...
  final alamat;
  final keys;
  _OnSaleWidgetState(this.nama, this.harga, this.alamat, this.images, this.keys);
              ...
              children: [
                Stack(
                  ...
                  IconButton(onPressed: (){
                    FirebaseDatabase.instance.ref().child('user').child(userId).child('like').child(keys).remove();
                  }, color: Colors.red, icon: Icon(Icons.close))
                ],
                ),
              ]
            ),
